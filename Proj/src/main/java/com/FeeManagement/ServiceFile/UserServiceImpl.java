...
public class UserServiceImpl implements UserService{
	...
	public int register(Student student) {
		...
		return jdbcTemplate.update(Regsql,
				new Object[] { student.getUserName(), student.getPassword(), student.getfName(), student.getmName(),
						student.getlName(), student.getYearOfJoin(), student.getEmail(), student.getBranch(),
						student.getDob() });
	}
